    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookies", x => x.BookieId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IconCategories", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Icons", x => x.ItemId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrayerRopeCategories", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrayerRopes", x => x.ItemId);
                });
            ...
            migrationBuilder.InsertData(
                table: "StoreItems",
                columns: new[] { "StoreItemId", "ItemName" },
                values: new object[,]
                {
                    { 1, "Book" },
                    { 2, "Icon" },
