...
namespace parish_bookstore.Controllers
{
    public class IconController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IconId,Name,Price,Description")] Icon icon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IconId,Name,Price,Description")] Icon icon)
        {
            if (id != icon.IconId)
            {
                return NotFound();
