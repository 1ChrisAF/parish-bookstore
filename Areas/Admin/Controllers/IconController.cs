...
namespace parish_bookstore.Areas.Admin.Controllers
{
    ...
    public class IconController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemId,StoreItemId,CategoryId,BookieId,Name,Price,Quantity,Description,ImageName")] Icon icon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,StoreItemId,CategoryId,BookieId,Name,Price,Quantity,Description,ImageName")] Icon icon)
        {
            if (id != icon.ItemId)
            {
                return NotFound();
        ...
        {
          return (_context.Icons?.Any(e => e.ItemId == id)).GetValueOrDefault();
        }
    }
}
